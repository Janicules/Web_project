...
$get_mugs=$conn->prepare("SELECT * FROM `product` WHERE `product`.`Category`= 'Mug' ");
$get_mugs->execute();
?>
<!DOCTYPE html>
<html>
...
<nav>
	...
	<a class="tab" style="color:#fff">Mugs</a>
...
<script type="text/javascript">
	...
	function add(name, price){
		...
		location.href = 'addmugs.php?nameprod='+name+'&price='+price;
	}

</script>
<?php
	while ($row=$get_mugs->fetch()){
